...
css = css.replace(/"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif/g, "'-apple-system', 'BlinkMacSystemFont', 'SF Pro Display', 'SF Pro Text', sans-serif");
